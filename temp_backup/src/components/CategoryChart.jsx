    ...
    return (
        <div className="glass-panel card" style={{ padding: '15px' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '10px' }}>
                <h2 style={{ margin: 0, fontSize: '1rem' }}>📊 {viewType === 'expense' ? 'Gastos' : 'Receitas'} por Categoria</h2>
            ...
            {total === 0 ? (
                <p style={{ textAlign: 'center', color: 'var(--text-secondary)', padding: '20px 10px', fontSize: '0.9rem' }}>
                    Nenhuma {viewType === 'expense' ? 'despesa' : 'receita'} confirmada.
                </p>
            ) : (
                <>
